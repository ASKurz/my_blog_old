...
The new [Waking Up with Sam Harris](https://wakingup.com/home-reviews/?_ga=2.267492553.617729158.1538952176-2137086923.1448849490&utm_expid=.4j5YZcqhSKSYqCMuOBBY-A.1&utm_referrer=https%3A%2F%2Fsamharris.org%2F) app is also 

## Consider [Insight Timer](https://insighttimer.com)

![](/post/2018-10-07-dont-pay-to-meditate_files/IT_bowl.png){width=75%}
...
![](/post/2018-10-07-dont-pay-to-meditate_files/IT_languages.jpg){width=33%}
...
![](/post/2018-10-07-dont-pay-to-meditate_files/IT_duration.PNG){width=33%}

#### People and their voices.

Their deep library boasts an impressive cast of meditation leaders. I was happy to see some familiar high-profile meditation teachers, such as Tara Brach and Joseph Goldstein. But I have also discovered new favorites, like Stephen Pende Wormland and Dawn Mauricio. To be sure, the quality of the audio recordings varies. But more importantly, they also vary in terms of vocal tone and pacing. There should be a vocal style to suit just about everyone.

![](/post/2018-10-07-dont-pay-to-meditate_files/IT_teachers.PNG){width=33%}

#### Emphasis.

I’m an academic and generally prefer meditations that are secular and connected to the clinical literature. Happily, the Insight Timer library contains offerings based on mindfulness-based stress reduction (MBSR) and its derivatives (e.g., mindfulness-based cognitive therapy, mindfulness-based relapse prevention).

![](/post/2018-10-07-dont-pay-to-meditate_files/IT_mindfulness.PNG){width=33%}

But you can also find meditations grounded within a number of faith traditions.

![](/post/2018-10-07-dont-pay-to-meditate_files/IT_faith.PNG){width=33%}
...
![](/post/2018-10-07-dont-pay-to-meditate_files/IT_bowls.PNG){width=33%}
...
![](/post/2018-10-07-dont-pay-to-meditate_files/IT_timer.PNG){width=33%}
...
![](/post/2018-10-07-dont-pay-to-meditate_files/IT_track.PNG){width=33%}

[Yes, I agree with Richard McElreath: "The only problem with barplots is that they have bars" (p. 203, [*Statistical Rethinking*](https://bookdown.org/connect/#/apps/1850/access)). You can’t have everything.]
