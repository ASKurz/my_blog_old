...
![](/post/2018-10-07-dont-pay-to-meditate_files/IT_languages.jpg){width=30%}

```{r echo = FALSE, eval = F, fig.height = 3}
knitr::include_graphics('/post/2018-10-07-dont-pay-to-meditate_files/IT_languages.jpg')
```
...
![](/post/2018-10-07-dont-pay-to-meditate_files/IT_duration.PNG){width=30%}
...
If you go to the Profile section of the app, you’ll discover it keeps track of your use and displays various summaries in attractive bar plots [Yes, I agree with Richard McElreath: "The only problem with barplots is that they have bars" (p. 203, [*Statistical Rethinking*](https://bookdown.org/connect/#/apps/1850/access)). You can’t have everything.] Which leads me to my next point.
