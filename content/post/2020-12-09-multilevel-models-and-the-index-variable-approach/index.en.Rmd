...
[^1]: Given the data are coded 0/1, one could also use the Bernoulli likelihood [@Bürkner2020Parameterization, [*Binary and count data models*](https://CRAN.R-project.org/package=brms/vignettes/brms_families.html#binary-and-count-data-models)]. I'm just partial to the binomial.
