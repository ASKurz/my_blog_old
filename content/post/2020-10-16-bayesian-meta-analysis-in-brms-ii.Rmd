...
author: Solomon Kurz
date: '2020-10-16'
slug: bayesian-meta-analysis-in-brms-ii
categories: []
tags:
  - Bayesian
  - brms
...
You may have noticed this plot is based on the results of our multilevel model, `me1`. We could have done the same basic thing with the results from the more conventional meta-analysis mode, `me0`, too.
