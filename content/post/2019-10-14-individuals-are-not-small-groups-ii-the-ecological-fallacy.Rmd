...
author: ''
date: '2019-10-14'
slug: individuals-are-not-small-groups-ii-the-ecological-fallacy
categories: []
tags:
  - dynamic p-technique
  - idiographic
...
When people conclude results from group-level data will tell you about individual-level processes, even of the individuals whose data made up those group-level data, they commit the *ecological fallacy*. This can be odd and counterintuitive. Keep reading to wade into the topic more slowly.
...
Let's do a brief recap. With Simpson's paradox, we learned that the apparent association between two variables can be attenuated after conditioning on a relevant third variable. In the literature, that third variable is often a grouping variable like gender or college department.
