---
title: 'Effect sizes for experimental trials analyzed with multilevel growth models: One of two'
author: Solomon Kurz
date: '2021-01-26'
slug: []
categories: []
...
The series of miniature plots on the left shows the trajectory of each participant's raw data, over time. The larger plot on the right shows the average value for each of the experimental conditions, over time. Although there is some variation across individuals within experimental conditions, the plot on the right shows the experimental conditions had the same average values at baseline (`t1`), both conditions tended to increase over time, but the `treatment` condition showed larger changes over time, relative to the `control` condition.
...
Feingold displayed most of these statistics in his Table 1 (p. 46). Now we're ready to start defining the effect sizes. We'll start with the unstandardized kind.
...
* "Cohen's $d$" can refer to either a general class of standardized effect sizes, or to a specific standardized effect size.
